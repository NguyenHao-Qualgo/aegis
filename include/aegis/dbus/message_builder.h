...
public:
    static DBusMessage* make_error_reply(DBusMessage* message,
                                         const char* name,
    ...
    static void append_slot_dict(DBusMessageIter* dict,
                                 const Slot& slot,
                                 const Slot* primary_slot);

    static void append_inspect_dict(DBusMessageIter* dict,
                                    const Bundle& bundle);
