...
class IoTHubModuleClient : public IoTHubInterface {
   public:
    explicit IoTHubModuleClient();
    ...
    void DestroyIoTHubClient(IOTHUB_MODULE_CLIENT_HANDLE clientHandle) override;
    ...
    IOTHUB_CLIENT_RESULT SendEventAsync(IOTHUB_MODULE_CLIENT_HANDLE clientHandle,
    ...
    //     IOTHUB_MODULE_CLIENT_HANDLE clientHandle,
    //     IOTHUB_MESSAGE_HANDLE eventMessageHandle,
    //     IOTHUB_CLIENT_EVENT_CONFIRMATION_CALLBACK eventConfirmationCallback,
    //     void *userContextCallback, const char* outputName) override;

    IOTHUB_CLIENT_RESULT SetInputMessageCallback(IOTHUB_MODULE_CLIENT_HANDLE clientHandle, const char* inputName,
        IOTHUB_CLIENT_MESSAGE_CALLBACK_ASYNC eventHandlerCallback, void* userContextCallback) override;

    IOTHUB_CLIENT_RESULT GetPropertiesAndSubscribeToUpdatesAsync(IOTHUB_MODULE_CLIENT_HANDLE clientHandle,
        IOTHUB_CLIENT_PROPERTIES_RECEIVED_CALLBACK propertiesCallback, void* userContextCallback) override;

    IOTHUB_CLIENT_RESULT
    GetTwinAsync(IOTHUB_MODULE_CLIENT_HANDLE clientHandle, IOTHUB_CLIENT_DEVICE_TWIN_CALLBACK twinCallback,
        void* userContextCallback) override;
    ...
    IOTHUB_CLIENT_RESULT SetConnectionStatusCallback(IOTHUB_MODULE_CLIENT_HANDLE iotHubModuleClientHandle,
    ...
    IOTHUB_CLIENT_RESULT SubscribeToDirectMethodCommands(IOTHUB_MODULE_CLIENT_HANDLE iot_hub_module_client_handle,
        IOTHUB_CLIENT_COMMAND_CALLBACK_ASYNC command_callback, void* user_context_callback) override;

    IOTHUB_CLIENT_RESULT SendReportedState(IOTHUB_MODULE_CLIENT_HANDLE iot_hub_module_client_handle,
