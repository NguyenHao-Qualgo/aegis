...
void install_raw_image(StreamReader &reader,
    ...
    log_stream("raw handler: target device='" + target.string() +
    ...
    log_stream("raw handler: completed direct stream write to '" + target.string() + "'");
}
...
void install_raw_file(StreamReader &reader,
    ...
    log_stream("raw handler: target file='" + path.string() + "', temp='" +
    ...
    log_stream("raw handler: completed streamed file install to '" + path.string() + "'");
}
